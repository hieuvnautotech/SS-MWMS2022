...
function Grid()
{
    grid.jqGrid({
        ...
        colModel: [
            ...
            { label: 'Check QC', name:'CheckQC', align: 'center', formatter: CheckQC, width: 80, },
            ...
            { label: 'Composite Code', name: 'MaterialCode', sortable: true, width: 400, align: 'left' },
            { label: 'PO NO', name: 'at_no', sortable: true, width: 150, align: 'center' },
            { label: 'Product', name: 'product', sortable: true, width: 150, align: 'center' },
        ],
        pager: '#listpage',
        height: 300,
        width: null,
...
$("#OK").jqGrid({
    ...
    colModel: [
        ...
        { label: 'Composite Code', name: 'orgin_mt_cd', sortable: true, width: 400, align: 'left' },
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.result == true) {
                    ...
                    $("#OK").setRowData(id, data.kq, { background: "#d0e9c6" });
...
function Detail(cellValue, options, rowdata, action) {
    html = '<button  class="btn btn-sm btn-info button-srh" data-mt_cd="' + rowdata.MaterialCode + '"onclick="detail_con(this);">Detail</button>';
    return html;
}
...
function Click_checkQC(e) {
    ...
    $("#qc_mt_cd").val(rowData.MaterialCode);
    ...
    table_facline_qc(item_vcd, rowData.MaterialCode);
